...
// --- Robot Base Class-Create the context class ---
class Robot {
protected:
    WalkableRobot* walkBehavior;//compostion
    TalkableRobot* talkBehavior;//compostion 
    FlyableRobot* flyBehavior;//compostion
...
public:
    WorkerRobot(WalkableRobot* w, TalkableRobot* t, FlyableRobot* f)
        : Robot(w, t, f) {}//inline intization base class
