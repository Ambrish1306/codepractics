...
using namespace std;
//**************************************/
//classes → factory classes → client
...
int main() {
    ...
    BurgerFactory* myFactory = new SinghBurger(); //factory class object 

    Burger* burger = myFactory->createBurger(type); // both pointer are from base class virtual function 
